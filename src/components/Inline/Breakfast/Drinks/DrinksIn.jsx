...
import s from './DrinksIn.module.css';
...
import RecomDrinks from './RecomDrinks/RecomDrinks';
...
const DrinksIn = () => {
  ...
  return (
    <div className={s.Inline}>
      ...
      {!fromRecomendations && <RecomDrinks isAddButtonDisabled={isAddButtonDisabled} />}
      <BottomInfo 
      price={dish.price}
      text={dish.text} 
      weight={dish.weight}  
