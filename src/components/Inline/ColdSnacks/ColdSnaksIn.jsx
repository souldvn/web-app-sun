...
import s from './ColdSnaksIn.module.css'
import arrowback from '../../../assets/icons/arrowback.svg';
import basket from '../../../assets/icons/basketbig.svg';
import BottomInfo from '../BottomInfo/BottomInfo';
import { CartContext } from '../../Contextes/CartContext';
import RecColdSnacks from './RecColdSnaks/RecColdSnaks';
...
const ColdSnacksIn = () => {
  ...
  return (
    <div className={s.Inline}>
      ...
      {!fromRecomendations && <RecColdSnacks isAddButtonDisabled={isAddButtonDisabled} />}
