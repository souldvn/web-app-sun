...
const DoughIn = () => {
  ...
  return (
    <div className={s.Inline}>
      ...
      {!fromRecomendations && <RecDough isAddButtonDisabled={isAddButtonDisabled} />}
