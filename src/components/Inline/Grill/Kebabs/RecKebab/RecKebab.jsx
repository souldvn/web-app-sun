...
import s from './RecKebab.module.css';
...
const RecKebab = ({isAddButtonDisabled}) => {
  ...
  useEffect(() => {
    const fetchRecomendations = async () => {
      try {
        ...
        const snapshot = await get(child(dbRef, "recfkebabs")); // Измените путь на "recomendations"
        if (snapshot.exists()) {
