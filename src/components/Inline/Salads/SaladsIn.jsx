...
import s from './SaladsIn.module.css'
...
import RecSalads from './RecSalads/RecSalads';
...
const SaladsIn = () => {
  ...
  return (
    <div className={s.Inline}>
      ...
      {!fromRecomendations && <RecSalads isAddButtonDisabled={isAddButtonDisabled} />}
