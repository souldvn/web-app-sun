...
const SoupsIn = () => {
  ...
  return (
    <div className={s.Inline}>
      ...
      {!fromRecomendations && <RecSoups isAddButtonDisabled={isAddButtonDisabled} />}
